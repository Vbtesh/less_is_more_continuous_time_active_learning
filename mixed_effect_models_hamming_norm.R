...
# Experiment 2
## Analysis using accuracy from hamming (edit distance) norm
data_2 = read.csv('./data/editdist_lf_exp2.csv')
...
# Experiment 3
## Analysis using accuracy from hamming (edit distance) norm
data_3 = read.csv('./data/editdist_lf_exp3_wprior.csv')
...
# Experiment 4
## Analysis using accuracy from hamming (edit distance) norm
data_4 = read.csv('./data/editdist_lf_exp4_wprior.csv')
